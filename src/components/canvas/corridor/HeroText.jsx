 ...
 * - YOUNING in Rubik Scribble font (splits into letters during scroll)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for YOUNING split effect
    const letters = useMemo(() => [
        { char: 'Y', baseX: -1.35, splitDir: -2.4, delay: 0 },
        { char: 'O', baseX: -0.9, splitDir: -1.6, delay: 0 },
        { char: 'U', baseX: -0.45, splitDir: -0.8, delay: 0 },
        { char: 'N', baseX: 0, splitDir: 0, delay: 0 },
        { char: 'I', baseX: 0.45, splitDir: 0.8, delay: 0 },
        { char: 'N', baseX: 0.9, splitDir: 1.6, delay: 0 },
        { char: 'G', baseX: 1.35, splitDir: 2.4, delay: 0 },
    ], []);
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of YOUNING
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* YOUNING Letters - Rubik Scribble font with fade-in animation */}
